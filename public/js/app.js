...
async function loadHome() { const m = await import('./pages/home.js?v=1.6.0'); return m.renderHome; }
async function loadLogin() { const m = await import('./pages/login.js?v=1.6.0'); return m.renderLogin; }
async function loadLanding() { const m = await import('./pages/landing.js?v=1.6.0'); return m.renderLanding; }
async function loadPreview() { const m = await import('./pages/preview.js?v=1.6.0'); return m.renderPreview; }
async function loadMarket() { const m = await import('./pages/market.js?v=1.6.0'); return m.renderMarket; }
