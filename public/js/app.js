...
async function loadHome() { const m = await import('./pages/home.js?v=1.5.2-market-ui2'); return m.renderHome; }
...
async function loadMarket() { const m = await import('./pages/market.js?v=1.5.2-market-ui2'); return m.renderMarket; }
